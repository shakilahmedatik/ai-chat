...
export const env = {
  ...
  JWT_ACCESS_EXPIRES_IN: readJwtExpiresIn('JWT_ACCESS_EXPIRES_IN', '15m'),
  ...
  HF_MODERATION_URL: process.env.HF_MODERATION_URL || '',
  HF_SUMMARIZE_URL: process.env.HF_SUMMARIZE_URL || '',
